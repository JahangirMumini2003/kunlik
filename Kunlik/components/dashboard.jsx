...
function Dashboard() {
  ...
  return (
    <section className="dash dash--cont" id="b2b">
      <div className="wrap">
        <div className="dash-head">
          <span className="dash-livetag"><span className="lt-dot" aria-hidden="true"></span>Интерактивная демонстрация · кликабельно</span>
          <h3 className="dash-h3">Личный кабинет компании — business.kunlik.uz</h3>
          <p className="sec-sub">Заявки и люди, создание смен с расчётом стоимости, финансы, реквизиты и интеграции — весь временный персонал в одном дашборде. Переключайте вкладки.</p>
        </div>
