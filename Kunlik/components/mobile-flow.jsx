    ...
    <section className="flow sec-pad" id="flow">
      <div className="wrap">
        <div className="block-label">
          <span className="bl-tag b">Блок Б</span>
          <span className="bl-text">Для сотрудника · Mobile App</span>
        </div>
        <div className="flow-head">
          <h2 className="sec-title">Пять шагов от регистрации<br />до денег на карте</h2>
          <p className="sec-sub">Исполнитель закрывает смену в приложении — компании не нужно вести КДП, табели и расчёты вручную.</p>
        </div>
