    ...
    <section className="b2bb sec-pad">
      <div className="wrap">
        <div className="bn-head light">
          <span className="eyebrow on-dark">Фундаментальные выгоды для компании</span>
          <h2 className="sec-title">Жёсткие бизнес-аргументы,<br />а не маркетинг</h2>
          <p className="sec-sub on-dark-sub">Налоги, кадровое делопроизводство, пиковые нагрузки и юридические риски — что именно меняется в цифрах.</p>
        </div>
